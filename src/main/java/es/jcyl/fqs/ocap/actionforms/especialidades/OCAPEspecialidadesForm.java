package es.jcyl.fqs.ocap.actionforms.especialidades;

import es.jcyl.fqs.ocap.actionforms.comun.OCAPComunForm;
import java.sql.Date;

public class OCAPEspecialidadesForm extends OCAPComunForm {

	private static final long serialVersionUID = -401166493557025957L;
