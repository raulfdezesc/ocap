...
function validar(tipoAccion){
   ...
   if  (validacion ==0){
      if (tipoAccion == '<%=Constantes.INSERTAR%>') {
         enviar('OCAPMerModalidad.do?accion=insertar');    
      }else{
         enviar('OCAPMerModalidad.do?accion=grabar');
      }
   }
}

function volverConsulta() {   
   enviar('OCAPMerModalidad.do?accion=buscar&<%=Constantes.RECUPERAR_BUSQUEDA_ANTERIOR%>=<%=Constantes.SI%>');
}
...
<div class="ocultarCampo">
	...
	<div class="cuadroContenedor">
		<html:form action="/OCAPMerModalidad.do">
			...
			<div class="cajaformulario">
				<fieldset class="normales">
					...
					<logic:notEqual name="tipoAccion" value="<%=Constantes.INSERTAR%>">
						<html:hidden property="CModalidad_id" />&nbsp;                  
</logic:notEqual>
					...
					<logic:equal name="tipoAccion" value="<%=Constantes.VER_DETALLE%>">
						...
						<html:text property="DNombre" tabindex="18"
							styleClass="inputColor colocaNombreDetModalidad" size="60"
					...
					<logic:notEqual name="tipoAccion"
						...
						<label class="obligado">* Nombre:</label>
						<html:text property="DNombre" tabindex="18"
							styleClass="inputColor colocaNombreModalidad" size="60"
							maxlength="100" />&nbsp;                  
</logic:notEqual>
