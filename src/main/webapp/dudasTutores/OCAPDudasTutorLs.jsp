...
function limpiar(){
   ...
   document.forms[0].BCambioTipo.value='';
   document.forms[0].FInicio.value='';
   document.forms[0].FFin.value='';
   if (document.forms[0].BContestado.value == '<%=Constantes.SI%>'){
...
function buscar(campo){
   enviar('OCAPDudasTutores.do?accion=buscarDudasTutores&<%=Constantes.ORDENACION%>='+campo+'&<%=Pagina.PRIMER_REGISTRO_PARAMETER_NAME%>=<%=Pagina.DEFAULT_PRIMER_REGISTRO%>&contestadas=<bean:write name="OCAPDudasTutoresForm" property="BContestado" />');
}
...
<div class="contenido contenidoFaseIII">
	...
	<html:form action="/OCAPDudasTutores.do">
		...
		<fieldset>
			...
			<html:hidden property="CTipoTutor" />

			<div class="cuadroFieldset formulario formularioDudasTutor">
				...
				<div class="todo">
					...
					<html:errors property="cTemaId" />
				</div>
				<div class="dosTercios">
					<label class="nombreLargo" for="idVApell1"> Cambiada de
						tipo: </label>
					<html:select styleClass="corto" name="OCAPDudasTutoresForm"
						property="BCambioTipo">
						<html:option value="">Seleccione...</html:option>
						<html:option value="<%=Constantes.SI%>"><%=Constantes.SI_TEXTO_min%></html:option>
						<html:option value="<%=Constantes.NO%>"><%=Constantes.NO_TEXTO_min%></html:option>
					</html:select>
				</div>
				<html:errors property="bCambioTipo" />

				<div class="todoFecha">
					<label class="nombreLargo" for="idVApell1"> Fecha de
						recepci&oacute;n entre: </label>
					<html:text styleClass="corto ajusteIE" name="OCAPDudasTutoresForm"
						property="FInicio" maxlength="16" />
				...
				<logic:equal name="OCAPDudasTutoresForm" property="BContestado"
					value="<%=Constantes.SI%>">
					<div class="todoFecha">
						<label class="nombreLargo" for="idVFRespueta1"> Fecha de
							respuesta entre: </label>
						<html:text styleClass="corto ajusteIE" name="OCAPDudasTutoresForm"
							property="FInicioRespuesta" maxlength="16" />
						<a class="iconoCalendario"
			...
			<div class="botonesPagina colocaBotonBusc">
				<div class="botonAccion">
					<span class="izqBoton"></span> <span class="cenBoton"> <a
						href="javascript:enviar('OCAPDudasTutores.do?accion=buscarDudasTutores');">
		...
		<logic:equal name="OCAPDudasTutoresForm" property="jspInicio"
			...
			<div class="cuadroListadoResultadosFormulario">
				<fieldset>
					...
					<table border="0" class="resultadosFaseIII listadoDudasTutor">
						<logic:notPresent name="sinDatos">
							<tr class="cabeceraListadoDudas">
								...
								<th class="tema" id="cTemaId"><a
									href="javascript:buscar('d_tema');" title="Ordenar por tema">Tema
										<logic:equal name="<%=Constantes.ORDENACION%>" value="d_tema">
											<logic:equal name="<%=Constantes.ORDENACION_CONTADOR%>"
												value="0">
												<html:img src="imagenes/imagenes_ocap/flechaBlancaDes.gif"
													border="0" alt="Descendente" />
								...
								<th class="fechaRecepcion" id="fRecepcion"><a
								...
								<!-- Para dudas pendientes, el tutor de tipo 2 puede reasignarlas a otro tutor -->
								<logic:equal name="OCAPDudasTutoresForm" property="CTipoTutor"
									value="<%=Integer.toString(Constantes.TIPO_TUTOR_GUIA_2)%>">
									<th id="reasignar"><a
										href="javascript:buscar('d_nombre');"
							...
							<logic:present name="listados" property="elementos">
								<logic:iterate id="elemento" name="listados"
									...
									<tr>
										...
										<td class="separador tema" headers="cTemaId"><a
										...
										<logic:equal name="OCAPDudasTutoresForm"
											property="BContestado" value="<%=Constantes.SI%>">
											<td class="separador derecha" headers="tiempoRespuesta">
												<bean:write name="elemento" property="tiempoRespuesta" />
											</td>
										</logic:equal>
										<!-- Para dudas pendientes, el tutor de tipo 2 puede reasignarlas a otro tutor -->
										<logic:equal name="OCAPDudasTutoresForm" property="CTipoTutor"
											value="<%=Integer.toString(Constantes.TIPO_TUTOR_GUIA_2)%>">
											<td headers="reasignar"><bean:write name="elemento"
													property="DNombreTutor" /> <bean:write name="elemento"
													property="DApellidosTutor" /></td>
											<td><logic:notEqual name="OCAPDudasTutoresForm"
													property="BContestado" value="<%=Constantes.SI%>">
													<a
														href="OCAPDudasTutores.do?accion=reasignarDuda&cDudaIdS=<bean:write name="elemento" property="CDudaId"/>">
														<img src="imagenes/imagenes_ocap/reasignar.gif"
