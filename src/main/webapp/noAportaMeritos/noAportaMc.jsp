...
function ejecuta(){
	...
	if(document.forms[0].CConvocatoriaId.value != ""){
		if (confirm('Se va a ejecutar un procedimiento que establecerá en estado "No aporta méritos curriculares" a todas las solicitudes que no hayan aportado méritos curriculares. ¿Desea continuar?')){
     		enviar('OCAPNoAportaMeritos.do?accion=ejecutarMc');
     	}
  	}else{
...
<div class="contenido">
	<div class="contenidoListadoAspirantesGCP listadoFaseIII">
		...
		<html:form action="/OCAPSolicitudes.do">
			...
			<h2 class="tituloContenido">SOLICITUDES QUE NO APORTAN M&Eacute;RITOS CURRICULARES</h2>
			<h3 class="subTituloContenido">Procedimiento para marcar solicitudes en estado "No aporta m&eacute;ritos curriculares"</h3>
