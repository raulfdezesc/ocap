		...
		<html:form action="/OCAPSolicitudes.do">
			...
			<fieldset>
				...
				<div class="cuadroFieldset">
					<p>Este procedimiento s&oacute;lo se puede ejecutar tras haber finalizado la fase de m&eacute;ritos curriculares. Como no hay ninguna convocatoria activa que cumpla este requisito, no es posible lanzar el procedimiento.</p>
				</div>
			</fieldset>
