...
var A_MENUS = [];
var Z_INDEX_MENU=150; //z-index mínimo de la capa del menú
var BLOQUEO_SUCESOS = true;
...
function menu_item (o_parent, n_order) {
	...
	document.write (
		'<a id="e' + o_root.n_id + '_'
			...
			+' z-index: ' + (Z_INDEX_MENU+this.n_depth) + ';" '
			+ 'onclick="'+(this.a_config[2] && this.a_config[2]['js'] ? this.a_config[2]['js']:'')
      
      +'return A_MENUS[' + o_root.n_id + '].onclick('
