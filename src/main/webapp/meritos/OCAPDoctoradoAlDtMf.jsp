...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form action="/OCAPMeritos.do?accion=controlAccionDoctorado">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Doctorado: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaDocDoctoradoMC" maxlength="150" />
						</label> <br />
						...
						<br /> <label for="idVFechaF"> Lugar de
							expedici&oacute;n: * <html:text property="ALugarExpedicion"
								tabindex="2" styleClass="recuadroM colocaLugarDoctoradoMC"
								maxlength="100" />
						</label> <br />
					</div>
				</fieldset>
