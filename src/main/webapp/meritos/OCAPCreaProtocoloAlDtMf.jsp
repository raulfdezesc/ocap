...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form action="/OCAPMeritos.do?accion=controlAccionCreaProtocolo">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> T&iacute;tulo Protocolo: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaTitRevisaProtoProcedMC"
								maxlength="150" />
						</label> <br />
						<br /> <label for="idVFechaI"> Fecha de Aprobaci&oacute;n
							institucional del proyecto: (dd/mm/aaaa) * <html:text
								...
								<a id="calFPlaza" class="iconoCalendario"
						...
						<br /> <label for="idVFechaF"> Fecha de Aprobaci&oacute;n
							del fin del proyecto: (dd/mm/aaaa) * <html:text
								property="FFinalizacion" tabindex="2"
								styleClass="recuadroM colocaFechasMC2" maxlength="10" /> <logic:notPresent
								name="OCAPMeritosForm" property="BDetalle">
								<a id="calFPlaza" class="iconoCalendario"
