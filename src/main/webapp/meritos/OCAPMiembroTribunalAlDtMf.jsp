...
<div class="ocultarCampo">
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<br />
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionMiembroTribunal">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Bolet&iacute;n: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaTribunalMiembroTribunalMC"
								maxlength="150" />
						</label> <br />
						<br /> <label for="idVFechaI"> Fecha de publicaci&oacute;n
							del bolet&iacute;n: (dd/mm/aaaa) * <html:text property="FInicio"
