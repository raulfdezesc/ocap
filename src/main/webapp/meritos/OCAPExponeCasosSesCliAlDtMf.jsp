...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionExponeCasosSesCli">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> T&iacute;tulo Sesi&oacute;n
							Cl&iacute;nica: * <html:text property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaTitCasosSesMC" maxlength="150" />
						</label> <br />
