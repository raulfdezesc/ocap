...
<div class="ocultarCampo">
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<br />
			<br />
			<html:form action="/OCAPMeritos.do?accion=controlAccionEstancia">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Descripci&oacute;n de la estancia:
							* <html:text property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaDescEstanciaMC" maxlength="150" />
						</label> <br />
						<br /> <label for="idVFechaF"> Lugar de
							realizaci&oacute;n: * <html:text property="ALugarExpedicion"
								tabindex="2" styleClass="recuadroM colocaLugarEstanciaMC"
								maxlength="100" />
						</label> <br />
