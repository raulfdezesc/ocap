...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionPublicacionRevistaProf">
				<div class="mensajeErrorMC">
					<html:messages id="aNombreRevista" property="aNombreRevista"
						message="true">
						<bean:write name="aNombreRevista" />
						<br />
					</html:messages>
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Nombre de la revista: * <html:text
								property="ANombreRevista" tabindex="1"
								styleClass="recuadroM colocaNombreRevistaProfMC" maxlength="255" />
						</label> <br />
						<br /> <label for="idVTitulo"> T&iacute;tulo de la
							publicaci&oacute;n: * <html:text property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaTitRevistaProfMC" maxlength="150" />
						</label> <br />
						<br /> <label for="idVFechaI"> Fecha de
							publicaci&oacute;n: (dd/mm/aaaa) * <html:text
