...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form action="/OCAPMeritos.do?accion=controlAccionMaster">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> T&iacute;tulo: * <html:text
								...
								styleClass="recuadroM colocaTitMasterMC" maxlength="150" />
						</label> <br />
						...
						<br /> <label for="idVImpartido"> Organizado / Impartido
							por: * <html:text property="AOrganizador" tabindex="3"
								styleClass="recuadroM colocaOrganMasterMC" maxlength="100" />
						</label>
					</div>
				</fieldset>
