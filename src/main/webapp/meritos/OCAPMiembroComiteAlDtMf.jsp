...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form action="/OCAPMeritos.do?accion=controlAccionMiembroComite">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Nombre del Congreso: * <html:text
								...
								styleClass="recuadroM colocaNomComiteMC" maxlength="150" />
						</label> <br />
						<br /> <label for="idVFechaI"> Fecha de realización:
