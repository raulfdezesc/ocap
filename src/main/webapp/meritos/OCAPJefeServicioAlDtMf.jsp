...
<div class="ocultarCampo">
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<br />
			<br />
			<html:form action="/OCAPMeritos.do?accion=controlAccionJefeServicio">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVFechaI"> Fecha designaci&oacute;n:
						...
						</label> <label for="idVFechaF"> Fecha finalizaci&oacute;n:
