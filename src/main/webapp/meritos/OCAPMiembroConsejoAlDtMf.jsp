...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionMiembroConsejo">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> ZBS / AS (Zona b&aacute;sica de
							Salud / &Aacute;rea Sanitaria): * <html:text property="DTitulo"
								tabindex="1" styleClass="recuadroM colocaZonaMiembroConsejoMC"
								maxlength="150" />
						</label> <br />
