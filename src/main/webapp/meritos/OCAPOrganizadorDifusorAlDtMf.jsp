...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionOrganizadorDifusor">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> T&iacute;tulo de la actividad: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaTitOrganizadorMC" maxlength="150" />
						</label> <br />
