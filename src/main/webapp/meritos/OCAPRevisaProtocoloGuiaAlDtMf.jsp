...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionRevisaProtocoloGuia">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> T&iacute;tulo Protocolo /
							Gu&iacute;a Asistencia: * <html:text property="DTitulo"
								tabindex="1" styleClass="recuadroM colocaTitProtocoloGuia"
								maxlength="150" />
						</label> <br />
