...
<div class="ocultarCampo">
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<br />
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionParticipaProyecto">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> T&iacute;tulo: * <html:text
								...
								styleClass="recuadroM colocaTitParticipaMC" maxlength="150" />
						</label> <br />
						...
						<br /> <label for="idVImpartido"> Entidad que lo convoca:
							* <html:text property="AOrganizador" tabindex="3"
								styleClass="recuadroM colocaNomComiteMC" maxlength="100" />
						</label> <br />
					</div>
				</fieldset>
