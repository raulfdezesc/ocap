...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form action="/OCAPMeritos.do?accion=controlAccionEspecialidad">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Especialidad: * <html:text
								...
								styleClass="recuadroM colocaEspecEspecialidadMC" maxlength="150" />
						</label> <br />
						...
						<br /> <label for="idVFechaF"> Lugar de
							expedici&oacute;n: * <html:text property="ALugarExpedicion"
								tabindex="2" styleClass="recuadroM colocaLugarEspecialidadMC"
								maxlength="100" />
						</label> <br />
					</div>
				</fieldset>
