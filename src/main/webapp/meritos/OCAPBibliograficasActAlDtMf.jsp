...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionBibliograficasAct">
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> T&iacute;tulo de la Sesi&oacute;n:
							* <html:text property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaTituloSesionMC" maxlength="100" />
						</label> <br /> <br /> <label for="idVFechaI"> Fecha de Inicio:
						...
						<br /> <label for="idVNHoras"> N&ordm; Horas: * <html:text
								...
								styleClass="recuadroM colocaNHorasMC" maxlength="5" />
						</label> <br />
