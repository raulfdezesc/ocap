...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form action="/OCAPMeritos.do?accion=controlAccionModeradorMesa">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Título del evento: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaTitModeradorMC" maxlength="150" />
						</label> <br />
						<br /> <label for="idVFechaI"> Fecha del evento: * <html:text
