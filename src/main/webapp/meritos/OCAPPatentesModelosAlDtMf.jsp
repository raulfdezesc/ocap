...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionPatentesModelos">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Nombre de patente y/o modelo: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaNomPatenteMC" maxlength="150" />
						</label> <br />
						<br /> <label for="idVFechaI"> Fecha de reconocimiento:
