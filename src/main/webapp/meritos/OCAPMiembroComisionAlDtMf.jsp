...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionMiembroComision">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Comisi&oacute;n: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaComiMiembroComisionMC"
								maxlength="150" />
						</label> <br />
