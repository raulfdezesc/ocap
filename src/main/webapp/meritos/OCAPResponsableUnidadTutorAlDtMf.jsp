...
<div class="ocultarCampo">
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<br />
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionResponsableUnidadTutor">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Unidad docente: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaUnidadUnidadTutor" maxlength="150" />
						</label> <br />
						<br />
						...
						<logic:notEqual name="tamanoListaActividades" value="0">
							<span> Tipo de Responsabilidad: * </span>
							<br />
							<br />
							<logic:iterate id="lActividades" name="OCAPMeritosForm"
								...
								<div class="radioEnCuadro flotaIzq radiosMC">
									<div class="flotaIzq colocaExpertoMasterMC">
										...
										<span> <bean:write name="lActividades"
												property="DNombre" />
											<bean:write name="lActividades" property="DObservaciones" /></span>
									</div>
								</div>
								<br />
								<br />
						...
						<label for="idVFechaI"> Fecha de inicio: (dd/mm/aaaa) * <html:text
