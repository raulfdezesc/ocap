...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form action="/OCAPMeritos.do?accion=controlAccionLicenDiplo">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						<logic:notEqual name="OCAPMeritosForm"
							...
							<label for="idVTitulo"> <span class="textoCursivaMC"><bean:write
										name="OCAPMeritosForm" property="DDescripcionMerito"
										filter="false" /></span>
							</label>
							<br />
							<br />
						...
						<label for="idVTitulo"> Licenciatura/Diplomatura: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaTitDiploMC" maxlength="150" />
						</label> <br />
						<br /> <label for="idVFechaI"> Fecha de
							Expedici&oacute;n: (dd/mm/aaaa) * <html:text
						...
						<br /> <label for="idVFechaF"> Lugar de
							expedici&oacute;n: * <html:text property="ALugarExpedicion"
								tabindex="2" styleClass="recuadroM colocaLugarDiploMC"
								maxlength="100" />
						</label> <br />
					</div>
				</fieldset>
