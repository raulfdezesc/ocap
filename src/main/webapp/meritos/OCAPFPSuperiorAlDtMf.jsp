...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form action="/OCAPMeritos.do?accion=controlAccionOtroFP">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Titulaci&oacute;n F.P.: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaTitFPSuperiorMC" maxlength="150" />
						</label> <br />
						...
						<br /> <label for="idVFechaF"> Lugar de
							expedici&oacute;n: * <html:text property="ALugarExpedicion"
								tabindex="2" styleClass="recuadroM colocaLugarFPSuperiorMC"
								maxlength="100" />
						</label> <br />
					</div>
				</fieldset>
					...
					<logic:notPresent name="OCAPMeritosForm" property="BDetalle">
						...
						<div class="botonAccion">
							<span class="izqBoton"></span> <span class="cenBoton"> <logic:equal
									...
									<img src="imagenes/imagenes_ocap/icon_accept.gif"
										alt="Imagen Modificacion Merito" />
									<input class="textoBotonInput" type="submit" name="accionBoton"
