...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionResponsableComisionCal">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Centro / Servicio: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaCentroResponsableComiMC"
								maxlength="150" />
						</label> <br />
