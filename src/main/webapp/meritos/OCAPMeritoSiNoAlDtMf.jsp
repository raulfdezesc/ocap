...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form action="/OCAPMeritos.do?accion=controlAccionMeritoSiNo">
				<div class="mensajeErrorMC">
					<html:messages id="bParticipacion" property="bParticipacion"
						message="true">
						<bean:write name="bParticipacion" />
					</html:messages>
				</div>
				<fieldset>
					...
					<div class="cuadroFieldset">
						<logic:notEqual name="OCAPMeritosForm"
							...
							<label for="idVTitulo" class="textpJustificado"> <span
						...
						<span> Participa: * </span> <br />
						<br />
						<div class="tituloEnCuadro flotaIzq radiosMC">
							<span> <%=Constantes.SI_TEXTO%>
							</span>
							<html:radio styleClass="altoRadios" property="BParticipacion"
								value="<%=Constantes.SI%>" />
						</div>
						<div class="tituloEnCuadro flotaIzq radiosMC">
