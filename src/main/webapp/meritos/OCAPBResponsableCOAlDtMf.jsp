...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionBResponsableCO">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Actividad organizativa: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaActiBResponsable" maxlength="150" />
						</label> <br />
