...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form
				action="/OCAPMeritos.do?accion=controlAccionEvaluadorProyectos">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> T&iacute;tulo del proyecto: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaTitEvaluadorMC" maxlength="150" />
						</label> <br />
						<br /> <label for="idVTitulo"> Agencia p&uacute;blica de
							investigaci&oacute;n: * <html:text property="AOrganizador"
								tabindex="1" styleClass="recuadroM colocaAgenciaEvaluadorMC"
								maxlength="100" />
						</label><br /> <br /> <label for="idVFechaI"> Fecha de
							realización de la evaluaci&oacute;n: (dd/mm/aaaa) * <html:text
