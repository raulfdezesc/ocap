...
<div class="ocultarCampo">
	...
	<div class="contenido">
		<div class="contenidoAltaMC">
			...
			<html:form action="/OCAPMeritos.do?accion=controlAccionMiembroGrupo">
				...
				<fieldset>
					...
					<div class="cuadroFieldset">
						...
						<label for="idVTitulo"> Grupo de trabajo: * <html:text
								property="DTitulo" tabindex="1"
								styleClass="recuadroM colocaGrupoMiembroGrupoMC" maxlength="150" />
						</label> <br />
						<br /> <label for="idVTitulo"> Cargo: * <html:text
								property="ACargo" tabindex="1"
								styleClass="recuadroM colocaCargoMiembroGrupoMC" maxlength="100" />
						</label> <br />
						<br /> <label for="idVTitulo"> Objetivo: * <html:text
								property="AObjetivo" tabindex="1"
								styleClass="recuadroM colocaObjetivoMiembroGrupoMC"
								maxlength="100" />
						</label> <br />
