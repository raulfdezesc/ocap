		...
		<html:form action="/OCAPSolicitudes.do">
			...
			<fieldset>
				...
				<div class="cuadroFieldset">
					<p>Se han reabierto sus m&eacute;ritos curriculares. Puede volver a rellenar/revisar los apartados que considere oportuno. Recuerde finalizar el proceso una vez haya concluido.</p>
				</div>
			</fieldset>
