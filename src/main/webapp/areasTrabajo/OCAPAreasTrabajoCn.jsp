...
function validar(){
   ...
   if ((document.OCAPAreasTrabajoForm.DCreacion.value != "" ) || (document.OCAPAreasTrabajoForm.MCreacion.value != "" ) || (document.OCAPAreasTrabajoForm.ACreacion.value != "")){
      var fecha = document.OCAPAreasTrabajoForm.DCreacion.value + '/' + document.OCAPAreasTrabajoForm.MCreacion.value + '/' + document.OCAPAreasTrabajoForm.ACreacion.value;      
   ...
   if ((document.OCAPAreasTrabajoForm.DModificacion.value != "" ) || (document.OCAPAreasTrabajoForm.MModificacion.value != "" ) || (document.OCAPAreasTrabajoForm.AModificacion.value != "")){
      var fecha = document.OCAPAreasTrabajoForm.DModificacion.value + '/' + document.OCAPAreasTrabajoForm.MModificacion.value + '/' + document.OCAPAreasTrabajoForm.AModificacion.value; 
...
function bajasClave(cAreaId)
{
   if (confirm('Va a ELIMINAR el registro selecionado')){
      document.forms[0].action = 'OCAPAreasTrabajo.do?accion=borrar';
...
<html:form action="/OCAPAreasTrabajo.do?accion=buscar">
	...
	<div class="ocultarCampo">
		...
		<div class="cuadroContenedorConsultas">
			<div class="titulocajaformulario">Consulta de Area de Trabajo</div>
...
return false;"><img
									...
									<td class="campoIcono"><a
										href="OCAPAreasTrabajo.do?accion=irEditar&cAreaIdS=<bean:write name="elemento" property="CAreaId"/>">
											<img src="imagenes/editar.gif" title="Editar registro"
											alt="Editar registro">
									</a></td>
									<td class="col1" headers="cNombre"><a
										href="OCAPAreasTrabajo.do?accion=detalle&cAreaIdS=<bean:write name="elemento" property="CAreaId"/>">
